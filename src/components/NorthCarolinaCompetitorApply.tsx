...
export function NorthCarolinaCompetitorApply({ config }: { config: StateConfig }) {
  ...
  const residencyLabel = (value: string) => {
    if (value === "resident") return t("nc.resident");
  ...
  return (
    <div className="mx-auto w-full max-w-xl">
      ...
      <div className="rounded border border-slate-200 bg-white px-4 py-6 shadow-sm sm:px-6">
        ...
        {step === 0 && (
          <>
            <h2 className="text-xl font-bold text-slate-900">{t("nc.step0Title")}</h2>
            <p className="mt-1 text-sm text-slate-500">{t("nc.step0Sub")}</p>
