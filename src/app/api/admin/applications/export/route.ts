...
export async function GET(req: Request) {
  ...
  try {
    ...
    workbook.lastModifiedBy = "AnglerPermit CRM";
    workbook.created = new Date();
    workbook.modified = new Date();
    workbook.company = "AnglerPermit";
    ...
    const sheet = workbook.addWorksheet("Applications", {
      ...
      headerFooter: {
        oddHeader: "&LAnglerPermit CRM&RApplications export",
    ...
    title.height = 28;
    title.getCell(1).value = "AnglerPermit — Applications Export";
